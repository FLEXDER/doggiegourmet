...
/* ============================================================
   MASTER DASHBOARD — tabs entre Reportes y Catálogo
   ============================================================ */
function MasterDashboard({ session, onLogout }) {
  const [view, setView] = useS3('reports'); // 'reports' | 'catalog'
  ...
  return (
    <div className="inv2-page master">
          ...
          <div className="inv2-hero-row">
            <div>
              ...
              <h1 className="inv2-hero-title light">
                {view === 'reports' ? <>Reportes <em>de inventario</em></> : <>Catálogo <em>de productos</em></>}
              </h1>
              <p className="inv2-hero-sub light">
                {view === 'reports'
                  ...
                  : 'Administra los productos disponibles. Estos productos aparecen como sugerencias en los reportes y son la base del control de inventario.'}
              </p>
            </div>
          ...
          <div style={{
            ...
            <button
              ...
              style={{
                background: 'transparent',
                border: 'none',
                color: view === 'reports' ? 'var(--cream)' : 'rgba(250, 247, 242, 0.5)',
                fontFamily: 'inherit',
                fontSize: 14,
                fontWeight: 600,
                padding: '14px 20px',
                cursor: 'pointer',
                borderBottom: view === 'reports' ? '2px solid var(--green)' : '2px solid transparent',
                marginBottom: -1,
            ...
            <button
              ...
              style={{
                background: 'transparent',
                border: 'none',
                color: view === 'catalog' ? 'var(--cream)' : 'rgba(250, 247, 242, 0.5)',
                fontFamily: 'inherit',
                fontSize: 14,
                fontWeight: 600,
                padding: '14px 20px',
                cursor: 'pointer',
                borderBottom: view === 'catalog' ? '2px solid var(--green)' : '2px solid transparent',
                marginBottom: -1,
                transition: 'all 0.15s ease',
                letterSpacing: '0.01em'
              }}>
      ...
      {view === 'reports' ? <ReportsView /> : <CatalogView />}
    </div>);
